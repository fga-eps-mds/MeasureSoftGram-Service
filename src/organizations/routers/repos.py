...
from measures.views import CalculatedMeasureHistoryModelViewSet, LatestCalculatedMeasureModelViewSet
from metrics.views import CollectedMetricHistoryModelViewSet, LatestCollectedMetricModelViewSet
