...
class GithubMetricCollector:
    ...
    # TODO: Coletar outras métricas, pois somente estas não é suficiente para calcular as novas medidas
    metrics_types = [
        'commits_by_release',
        'release_issues',
        'health_percentage',
    ...
    def set_release_commits(self):
        """
        TODO: Adicionar docstring explicando qual métrica está sendo coletada
        """
        date = ""
